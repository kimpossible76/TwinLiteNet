...
class colabIADDataset(torch.utils.data.Dataset):
    '''
    Class to load the dataset
    '''
    def __init__(self, transform=None,valid=False):
...
class colabMIXEDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, transform=None,valid=False):
        ...
        self.valid=valid
        if valid:
            self.root1='/content/IADD/IADDv6/val/img'
            self.root2=''
            self.names=os.listdir(self.root1)
        else:
            self.root1='/content/iadd/img/content/train_p1_unlabeled'
            self.root2='/content/data/bdd100k/bdd100k/images/100k/train'
...
class colab_first_pseudo_label_dataset(torch.utils.data.Dataset):
    '''
    Class to load the dataset
    '''
    def __init__(self, transform=None,valid=False):
